...
const GERMAN_CITIES = [
    ...
    'leverkusen', 'göttingen', 'oldenburg', 'potsdam', 'paderborn',
    'reutlingen', 'esslingen', 'ludwigsburg', 'tübingen', 'tubingen',
    'konstanz', 'flensburg', 'jena', 'erfurt', 'schwerin',
];
